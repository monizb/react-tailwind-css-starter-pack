...
const ButtonComponent = (props) => {
  ...
  const buttonClasses = `h-6 px-2 py-[3px] bg-${backgroundColor} rounded-${rounded} inline-flex justify-center items-center gap-1.5 overflow-hidden ${customStyle} ${
  ...
  return (
    ...
    >
      ...
      <div className={`justify-start text-${textColor} text-${textSize} font-medium font-[${font}] leading-none`}>
